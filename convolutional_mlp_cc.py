...
def evaluate_lenet5(learning_rate=0.1, n_epochs=10000,
    ...
    # filtering reduces the image size to (7-4+1,7-4+1)=(4,4)
    # 4D output tensor is thus of shape (nkerns[1],nkerns[2],4,4)
    ...
    layer4 = LogisticRegression(input=layer3.output, n_in=1024, n_out=10)
    ...
    params = layer4.params + layer3.params + layer1.params + layer0.params#layer2.params + layer1.params + layer0.params
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if iter % 100 == 0:
                print('iter %d cost %f' % (iter, cost_ij))
                plotCost(costs,valid)
