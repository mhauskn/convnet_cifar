...
def load_data(dataset):
    ...
    '''
    for i in range(1,6):
        fname = os.path.join(dataset,'data_batch_'+str(i))
        ...
        if i == 1:
            ...
            train_data = numpy.concatenate((train_data,dict['data']))
            train_labels = numpy.concatenate((train_labels,dict['labels']))

    test_dict = cPickle.load(open(os.path.join(dataset,'test_batch'),'r'))
    ...
    valid_set_x, valid_set_y = shared_dataset((valid_data, valid_labels))
